...
function showTask(num) {
    ...
    var url = hostname + '/json2?status=' + num;
    $.ajax({
        type: "get",
        url: url,
        dataType: 'json',
            ...
            if (num == 0) {
                ...
                $.each(data['objects'], function (index, n) {
                    ...
                    $("#spliding").append(
                        ...
                        "<div class=\"row\">" +
                        "<div class=\"col-md-12\">" +
                        "<p><strong>配置id：</strong>" + n.id +
                        "</p>" +
                        "</div>" +
                        "<div class=\"col-md-12\">" +
                        "<p><strong>配置制定时间：</strong>" + n.time + "&nbsp;&nbsp; &nbsp;&nbsp;" +
                        "</p>" +
                        "</div>" +
                        "<div class=\"col-md-12\">" +
                        "<p><strong>配置种类：</strong>" + type +
                        "</p>" +
                        "</div>" +
                        "<div class=\"col-md-12\">" +
                        "<p><strong>任务：</strong>" + types +
                        "</p>" +
                        "</div>" +
                        "</div>" +
                        "</div>" +
...
//启动任务
function start(id) {
    var url=hostname+'/starts?id='+id+"&status=1";
